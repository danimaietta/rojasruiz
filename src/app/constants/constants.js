const constants = {
    HEADER_TEXTS: ['Conózcanos', 'Servicios', 'Proyectos', 'Contáctenos'],
    HEADER_OPTIONS: ['aboutus', 'services', 'projects', 'contact'],
    MAX_CHARACTERS: 300,
    REGEX_STRING: /^[a-zA-Z]*$/,
    REGEX_NUMBER: /^[0-9]*$/,
    ...
    NOSOTROS: {
        ...
        VISION_TITLE: 'VISIÓN',
        VISION_TEXT: 'Mediante una mejora continua, innovación, compromiso y trabajo… ofrecer a nuestros clientes el mejor servicio, soporte y eficiencia del mercado electromecánico',
    },
